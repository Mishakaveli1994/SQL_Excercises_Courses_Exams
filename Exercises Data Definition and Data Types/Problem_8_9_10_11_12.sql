...
CREATE TABLE Users(
	...
	-- Size of what is stored in the colum (in bytes), in this example max 900KB
...
ALTER TABLE Users
DROP CONSTRAINT [PK__Users__3214EC07A402CB1B] -- Drop Primary Key

ALTER TABLE Users
ADD CONSTRAINT [PK_Users_CompositeIdUsername] -- Create a composite Primary key from 2 fields
